...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="<?php echo $PUBLICIMG; ?>/profile_small.jpg"/></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="/index.php/admin/Login/loginout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main" style="height: 100%">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/index.php/admin/Index/home" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <!--        <div class="footer">-->
...
<script src="<?php echo $PUBLICJS; ?>/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/layer/layer.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/hplus.min.js?v=4.1.0"></script>
<script type="text/javascript" src="<?php echo $PUBLICJS; ?>/contabs.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/pace/pace.min.js"></script>
</body>
</html>
