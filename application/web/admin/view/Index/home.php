...
<head>
    ...
    <!-- Morris -->
    <link href="<?php echo $PUBLICCSS; ?>/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="<?php echo $PUBLICJS; ?>/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.spline.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.resize.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.pie.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/flot/jquery.flot.symbol.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/peity/jquery.peity.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/demo/peity-demo.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/content.min.js?v=1.0.0"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="<?php echo $PUBLICJS; ?>/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="<?php echo $PUBLICJS; ?>/demo/sparkline-demo.min.js"></script>
<script>
